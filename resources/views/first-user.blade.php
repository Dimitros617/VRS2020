...
{{--        </h2>--}}
    ...
    <div class="container p-6 text-center text-vrs-cyan">
        ...
        <div class="h6"> Provedly jsme pár věcí, vše nastavily, a vypadá to, že jste aktuálně jediný uživatel v systému. Proto jsme na Vás převedly veškerá práva, a stanovily Vás novým vládcem systému. Kliknutím na tlačítko „POKRAČOVAT“ můžete začít se správou celého systému a přizpůsobit si jej.
