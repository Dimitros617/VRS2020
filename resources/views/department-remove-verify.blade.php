...
<x-app-layout>
    ...
    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="container p-6">
            ...
            <form action="{{'/removeDepartmentHard/' . $department->id}}" method="POST" class="removeVerify text-center">
                @csrf
                ...
                <input type="text" class="d-none text-vrs-cyan mb-2" name="departmentId" value="{{$department->id}}">
                <br>
                <input class="btn btn-danger" type="submit" value="Smazat katedru {{$department->name}} i všechny její kategorie a položky">
            </form>
