                ...
                @if(old('saveCheck') == 1)
                    <div id="autoHide" class="alert-success">
                        ...
                        @else
                            ...
                            <div class="h1"> Aktuální výpůjčky :</div>


                            <div class="align-content-center">

                                <button class="btn btn-warning align-content- text-center" type="button"
                            ...
                            <div class="collapse" id="waitingLoans">
                                <div class="card card-body">
                                    ...
                                    @if(count($activeLoans)==0)
                                        <div>Aktuálně tu nemáme žádné záznamy</div>
                                    @endif
                        ...
                        <div class="itemDiv">
                            ...
                            <form action="{{'/loans/' . $loan->id .'/return'}}" method="POST" class="addNewCategory loan">
                                @csrf
