...
class Email extends Message
{
    ...
    /**
     * Sets the priority of this messages.
     *
    ...
    /**
     * Get the priority of this messages.
     *
    ...
    public function ensureValidity()
    {
        if (null === $this->text && null === $this->html && !$this->attachments) {
            throw new LogicException('A messages must have a text or an HTML part or attachments.');
        }
    ...
    /**
     * Generates an AbstractPart based on the raw body of a messages.
     *
