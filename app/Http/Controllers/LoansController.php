...
class LoansController extends Controller
{
    ...
    function showAllLoans(){
        ...
        $historyLoans = DB::table('loans_histories')->orderBy('name', 'asc')->orderBy('id', 'asc')->select('userId', 'name as userName', 'surname as userSurname',  'categoryId as categoryId', 'categories as categoryName',  'itemId as itemId', 'item as itemName', 'note', 'place' ,'inventory_number' , 'rent_from', 'rent_to')->get();
